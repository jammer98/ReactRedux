...
function Addtodo (){
    ...
    return(
      ...
      <input
        type="text"
        className="bg-gray-800  rounded-2xl  border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-4 px-8 leading-8 transition-colors duration-200 ease-in-out"
